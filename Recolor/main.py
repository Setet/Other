...
# Программа для уменьшения количества уникальных цветов на изображениях
class ColorizeApp:
    def __init__(self, master):
        # Инициализация главного окна приложения
        self.master = master
        self.master.title("Уменьшить количество уникальных цветов")
        ...
        self.button_start = tk.Button(self.master, text="Уменьшить количество уникальных цветов", command=self.start)
    ...
    def start(self):
        ...
        if self.n_colors > self.count_color:
            msg = "Количество выбранных цветов больше, количество цветов на начальном изображении"
            ...
            output_file_path = filedialog.asksaveasfilename(defaultextension=".png", initialdir=self.file_path)
